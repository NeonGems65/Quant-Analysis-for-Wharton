...
keyMetrics = getObj("https://financialmodelingprep.com/api/v3/key-metrics/AAPL?period=annual&apikey=plhWuAfrX80GENksssnk8tVYASXgVqoB")
...
# plot financial data using Plotly
    ...
    # --------------- Financials CSV ---------------        
    dfFinancials = ticker.yahoo_api_financials(period1=datetime(2022, 1, 1), period2=datetime.today())
    print(dfFinancials)
    ...
    dfBalance = getObj("https://financialmodelingprep.com/api/v3/balance-sheet-statement-as-reported/"+stockList[m]+"?period=annual&apikey=plhWuAfrX80GENksssnk8tVYASXgVqoB")
